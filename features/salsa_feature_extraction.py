...
def extract_features(data_dir: str = "../DCASE2024_SELD_dataset", feat_dir: str = "../DCASE2024_SELD_dataset/feat_labels",
                     ...
                     win_length:int = 512, hop_length:int = 300, fmin_doa:int = 50, fmax_doa: int = 9000,
    ...
    if task in ['feature_scaler', 'feature']:
        for split in splits:
            ...
            # Extract features
            with Progress() as feat_prog:
                feat_task = feat_prog.add_task("Extracting SALSA features", total=len(audio_fn_list))
                for count, audio_fn in enumerate(audio_fn_list):
                    ...
                    feat_prog.console.print('{}, {}, {}'.format(count, audio_fn, audio_feature.shape))
                    feat_prog.advance(feat_task)
