...
if __name__ == "__main__":
	base_dir = "./DCASE2024_SELD_dataset/"
	aug_dir = "./DCASE2024_SELD_dataset/aug_acs/"

	foa_dir = base_dir + "foa_dev"
	meta_dir = base_dir + "metadata_dev"
	mic_dir = base_dir + "mic_dev"

	foa_dir_aug = aug_dir + "foa_acs"
	meta_dir_aug = aug_dir + "metadata_acs"
	mic_dir_aug = aug_dir + "mic_acs"
